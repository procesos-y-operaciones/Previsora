...
Rails.application.config.assets.precompile += %w( coljuegos.js.coffee )
Rails.application.config.assets.precompile += %w( secrets.js.coffee )
Rails.application.config.assets.precompile += %w( type_process.js.coffee )
Rails.application.config.assets.precompile += %w( capture.js.coffee )
Rails.application.config.assets.precompile += %w( sinisters.js.coffee )
...
Rails.application.config.assets.precompile += %w( old.js.coffee )
