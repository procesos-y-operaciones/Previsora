...
class TypeProcess < ApplicationRecord
  ...
  def self.total_headers
    [
      ...
      'HAY IMPUGNACION?',	'HAY DESACATO?', 'TIPO DE PROCESO', 'USER ID'
    ]
  end
  ...
  def get_total_content
    [
      ...
      booleanValue(self.has_more_polcies), booleanValue(self.has_costs), booleanValue(self.has_coactive_radicate), booleanValue(self.has_impug), booleanValue(self.has_desacate), self.get_type_process, self.user_id
    ]
  end
