...
class TypeProcess < ApplicationRecord
  ...
  def self.tutelage_header
    [
      'IDENTIFICADOR','TIPO DE PROCESO','ABOGADO INTERNO','RADICADO CORRESPONDENCIA','NUMERO DE RADICACION DEL PROCESO','PARTE ACTIVA','PARTE PASIVA','IMPUGNANTE','NOMBRE DEL DESPACHO','DEPARTAMENTO','CIUDAD DONDE CURSA EL CASO','CLASE DE PROCESO','SUBCLASE DE PROCESO','TIPO DE VINCULACION','INSTANCIA','TERMINACION DEL CASO','TIPO DECISION IMPUGNACION','TIPO SENTENCIA INCIDENTE DESACATO','FECHA DE CREACION','FECHA DE NOTIFICACION','FECHA DE LA DECISION','FECHA DE CONTESTACION TUTELA','FECHA DECISION IMPUGNACION','FECHA DE NOTIFICACION DECISION IMPUGNACION','FECHA NOTIFICACION IMPUGNACION','FECHA NOTIFICACION DECISION O FALLO','FECHA NOTIFICACION INCIDENTE DESACATO','FECHA DE CONTESTACION INCIDENTE DESACATO','FECHA NOTIFICACION DECISION INDIDENTE DESACATO','TIENE NUMERO DE RADICADO EN CORRESPONDENCIA','TIENE IMPUGNACION','TIENE DESACATO','FECHA DE CREACION','ULTIMA ACTUALIZACION','ESTADO DE REGISTRO','OBSERVACIONES'
    ]
  end
