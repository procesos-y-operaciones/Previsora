...
class TypeProcess < ApplicationRecord
  ...
  def self.column_names_all
    [
      ...
      'CLASE DE PROCESO','SUBCLASE DE PROCESO', 'TIPO DE VINCULACION', 'PARTE ACTIVA','CC/NIT PA','PARTE PASIVA','CC/NIT PP',
  ...
  def get_content_all
    [
      ...
      self.get_process_class, self.get_subprocess_class, self.get_link_type, self.get_active_part,'NO APLICA', self.get_passive_part,'NO APLICA',
