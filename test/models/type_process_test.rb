...
#  creation_date                       :date             default(Mon, 01 Jan 1990)
#  notification_date                   :date             default(Mon, 01 Jan 1990)
#  process_radicate                    :string           default("PENDIENTE")
#  number                              :integer          default(0)
#  exercise                            :integer          default(0)
#  sinister                            :string           default("PENDIENTE")
#  attorny                             :string           default("PENDIENTE")
#  attorny_date                        :date             default(Mon, 01 Jan 1990)
...
#  desition_date                       :date             default(Mon, 01 Jan 1990)
...
#  payment_date                        :date             default(Mon, 01 Jan 1990)
...
#  last_performance_date               :date             default(Mon, 01 Jan 1990)
#  failed_notification_date            :date             default(Mon, 01 Jan 1990)
#  objection_notification_date         :date             default(Mon, 01 Jan 1990)
#  tutelage_imp                        :string           default("PENDIENTE")
#  date_notification_desacate          :date             default(Mon, 01 Jan 1990)
#  date_answer_desacate                :date             default(Mon, 01 Jan 1990)
#  date_notification_desition_desacate :date             default(Mon, 01 Jan 1990)
